  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        destructive: {
          ...
          light: {
            ...
            foreground: "hsl(var(--destructive-light-foreground))",
          },
        },
        muted: {
      ...
      keyframes: {
        ...
        // Adicionado keyframe para a animação do toast
      ...
      animation: {
        ...
        // Adicionada a animação para o toast
        "toast-progress":
          "toast-progress-animation linear forwards var(--duration-toast)",
      },
      borderRadius: {
        // Mantenha o borderRadius aqui, se já estava
        lg: "var(--radius)",
